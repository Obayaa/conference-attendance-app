...
//           </div>
//           <div
//             className="flex gap-2 bg-blue-950 text-white rounded-md p-2 cursor-pointer"
//             // onClick={toggleDrawer}
//             onClick={() => setShowModal(true)}
//           >
//             <Plus className="w-5 h-5 text-white mb-2" />
//             <p>Add New Member</p>
//           </div>
//         </div>
...
export default function AttendancePage() {
  ...
  // Called when AddNewMember successfully adds + marks attendance
  function handleNewMemberSuccess(memberName) {
    setTodayCount((prev) => prev + 1);
    setMessage({
      text: `✅ ${memberName} added and attendance marked successfully!`,
      type: "success",
    });
    ...
    <div className="max-w-3xl mx-auto">
      <div className="bg-white rounded-md shadow-md p-6 md:p-8 mb-4">
        ...
        <div className="flex items-center pb-3 justify-between">
          ...
          <div
            className="flex gap-2 bg-blue-950 text-white rounded-md p-2 cursor-pointer hover:bg-blue-900 transition"
        ...
        <div className="mb-4 relative">
          <div className="relative" ref={inputRef}>
            ...
            {searching && (
              <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                <div className="animate-spin h-4 w-4 border-2 border-indigo-600 rounded-full border-t-transparent" />
              </div>
            )}
            {query && !searching && (
              <button
